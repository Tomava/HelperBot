...
listOfCommands = {"!delete x": "This command deletes x amount of messages",
...
incorrectReminderFormat = ("Your message wasn't formatted correctly\n"
...
pathToReminders = home + os.sep + "Discord" + os.sep + "reminders"


def make_dirs():
    if not os.path.exists(pathToReminders):
        os.makedirs(pathToReminders)
